...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"inputHandler.ts":[function(require,module,exports) {
"use strict";
...
var inputHandler_1 = __importDefault(require("./inputHandler")); //inputHandler.enableDebug();


var displayUserInputs = document.getElementById('divUserInputs');
/** */

var render = function render() {
  displayUserInputs.innerHTML = inputHandler_1.default.getUserInputs().toString();
  window.requestAnimationFrame(render);
};

window.requestAnimationFrame(render);
},{"./inputHandler":"inputHandler.ts"}],"../../.nvm/versions/node/v14.17.5/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/inputHandler.77de5100.js.map